        ...
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center">
                <a href="<?php echo site_url('pengguna/produk/delete_data/'.$user['kode_produk']);?>" class="btn btn-sm btn-danger" onClick="return confirm('Apakah anda yakin menghapus data ini?')"><span class="tf-icons bx bx-trash-alt"></span></a>
                <a href="<?php echo site_url('pengguna/produk/editdata/'.$user['kode_produk']);?>" class="btn btn-sm btn-warning" ><span class="tf-icons bx bx-edit-alt"></span></a>     
                <a href="<?php echo site_url('pengguna/produk/foto/'.$user['kode_produk']);?>" class="btn btn-sm btn-primary" ><span class="tf-icons bx bx-image-add"></span></a>      
              </td>
            </tr>
            <?php $no++; } ?>
          </tbody>
...
<div class="modal-dialog modal-xl">
  <form class="modal-content" method="post" action="<?php echo site_url('pengguna/produk/simpan');?>">
