        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-8">
            <div class="card-body">
              ...
              <form method='post' action='<?php echo site_url('pengguna/produk/uploadfoto');?>' enctype='multipart/form-data'>
                <div class="row">
                  <div class="col-md-5">
    ...
    <div class="col-md-4" style="margin-bottom: 20px;">
      <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
          <a href="<?php echo site_url('pengguna/produk/delete_foto/'.$foto['namafile'].'/'.$u->kode_produk);?>" class="btn-close" onClick="return confirm('Apakah anda yakin menghapus foto ini?')"></a>
        </div>
